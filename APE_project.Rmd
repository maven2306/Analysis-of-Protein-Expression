...
# load decoy
filename_d <- "searchgui_results/decoy_results/JD_06232014_sample1-A.comet.pep.xml.gz" 
...
```{r}
# load target
filename_t <- "searchgui_results/top100_target_results/top100.comet.pep.xml.gz"
mzid_t <- openIDfile(filename_t)
# Combine data and scores
df_t <- cbind(psms(mzid_t), score(mzid_t))
